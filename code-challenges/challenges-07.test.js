...
const addTea = () => {
  // Solution code here...
  // const $newElement = $('<li>');
  // var $newItem = $('<li>tea</li>');
  // $('ul:last-child').append($newItem);
  $('ul:last-child').append('<li>tea</li>');
}
...
const forLoopTwoToThe = (arr) => {
  ...
  for(let i=0; i < arr.length; i++){
    const squaredArr = Math.pow(2, arr[i]);
    outputArr.push(squaredArr);
  }
  return outputArr;
};
...
const forEachTwoToThe = (arr) => {
  ...
  const outputArr = []
  arr.forEach(number => {
    const squaredArr = Math.pow(2, number);
    outputArr.push(squaredArr);
  });
  return outputArr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  // const squaredArr = arr.map(number => Math.pow(2, number));
  // return squaredArr;
