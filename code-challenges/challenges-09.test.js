...
function getCurrentEvents(request, response) {
  // Solution code here...
  response.send(mapCurrentEvents(request,response));
}

const mapCurrentEvents = (request, response) => {
  // Solution code here...
  const resultsArray = currentEvents.news.map(obj => new Event(obj));
  return resultsArray;
}
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const outputArr = arr.reduce(accumulator => {
